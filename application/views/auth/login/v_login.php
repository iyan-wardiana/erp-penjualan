...
<body class="vh-100">
	<div class="page-wraper">
		...
		<div class="browse-job login-style3">
			<!-- Coming Soon -->
			<div class="bg-img-fix overflow-hidden" style="background:#fff url(<?php echo base_url() ?>assets/images/background/bg6.jpg); height: 100vh;">
				<div class="row gx-0">
								...
								<div class="login-form style-2">
									...
									<div class="card-body">
										<div class="logo-header">
											<a href="index.html" class="logo"><img src="<?php echo base_url() ?>assets/images/logo/logo-full1.png" alt="" class="width-230 light-logo"></a>
											<a href="index.html" class="logo"><img src="<?php echo base_url() ?>assets/images/logo/logofull-white1.png" alt="" class="width-230 dark-logo"></a>
										</div>
										...
										<div class="tab-content w-100" id="nav-tabContent">
                                            ...
                                            <div class="alert alert-danger" role="alert">
                                                ...
                                                <i class="fa fa-frown-o me-2" aria-hidden="true"></i><?php echo $this->session->flashdata('message'); ?>
                                            </div>
                                            <?php endif; ?>
                                            <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
                                                <form action="<?php echo $form_acton; ?>" method="POST" class=" dz-form pb-3">
